...
def exchange(currency_from, currency_to, amount_from):
    ...
    def check_input():
        ...
        if type(amount_from) == float or type(amount_from) == int:
            pass
        else:
            print('the amount is invalid')
        if iscurrency(currency_from) and iscurrency(currency_to) and (type(amount_from) == float or type(amount_from) == int):
            return True
    if check_input():
